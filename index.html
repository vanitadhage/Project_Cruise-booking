...
<body>
    ...
    <main>
                ...
                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel" >
                  ...
                  <div class="btn">
                    <button style="font-size: 26px;">
                        <a href="userlogin.jsp">Explore More</a>
                        <div class="icon-1">
                          <svg
        ...
        <section id="destinations" class="section">
            <h2 id="dest">Our Destinations</h2>
                  ...
                  <div class="text">
                    <h2 id="gallary_text" style="margin-bottom: 50px;" >About Us</h2>
                      ...
                      <p> Welcome to Ocean Journey, your gateway to unforgettable cruise adventures around the world. At Ocean Journey, we believe in the transformative power of travel and the magic of exploring the open seas. Our mission is to provide exceptional cruise experiences that inspire, delight, and create lifelong memories for our passengers.
                        ...
                        At Ocean Journey, we go beyond simply booking cruises – we curate immersive journeys that showcase the beauty of our planet's oceans and the diverse cultures and landscapes they encompass. From world-class amenities and gourmet dining to thrilling shore excursions and onboard entertainment, we ensure that every aspect of your cruise experience exceeds expectations.</p>
                    <div class="data">
                    <a href="" class="hire">Join Us</a>
                    </div>
                  </div>
                </div>
              </section>
